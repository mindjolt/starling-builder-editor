package com.sgn.starlingbuilder.editor.utils
{
    ...
    public class AssetManager extends EventDispatcher
    {
        ...
        /**
         *  Copy from starling.utils.AssetManager in order to expose mAtlases
         * @return
         */

        public function getTextureAtlasDictionary():Dictionary
        {
            return mAtlases;
        }
    }
